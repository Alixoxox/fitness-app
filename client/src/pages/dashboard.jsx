  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mt-10">
      <div className="w-[90vw] text-left">
        <span className="text-3xl text-gray-600 font-bold">Dashboard</span>
      </div>
      ...
      <div className="home-container box-border overflow-hidden flex flex-col items-center justify-center w-[90vw] mt-8 mx-auto">
        <div className='flex justify-between w-full'>
          <div className="flex items-center ">
            <Link to="../acount"><img src={User} loading='eager' className='h-12' /></Link><h1 className='ms-4 text-3xl font-semibold ' >Today</h1>
          </div>
          <div className=" font-semibold  items-center flex gap-2"> <p className='text-3xl'>2</p> <div className=' flex text-sm flex-col p-0 m-0 leading-none gap-0'><span>DAYS</span><span>STREAK</span></div></div>
        </div>
